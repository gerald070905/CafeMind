...
Agent Controller Module - Central Orchestration Layer

This module implements the main controller that orchestrates all specialized agents,
routing queries through the Guard → Classification → Specialized Agent pipeline.
